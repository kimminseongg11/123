...
public class WorkOrderController {
    ...
    public HashMap<String, Object> workOrder(@RequestParam @ApiParam(value = "Mrp번호") String mrpNo,
                                             @RequestParam @ApiParam(value = "소요량취합번호") String mrpGatheringNo,
        ...
        HashMap<String, Object> resultMap = new HashMap<>();
        System.out.println("\n" + "디버깅 포인트 : 실제 작업 지시 ");
        System.out.println("C_mrpNo = " + mrpNo);
        ...
        try {
            resultMap = workOrderSF.workOrder(mrpNo, mrpGatheringNo, workPlaceCode, productionProcessCode);
        } catch (Exception e2) {
            e2.printStackTrace();
            resultMap.put("errorCode", -2);
            resultMap.put("errorMsg", e2.getMessage());
    ...
    public ResponseEntity<List<WorkOrderInfo>> getWorkOrderInfoListStatus() {
        ...
        System.out.println("\n" + "디버깅 포인트 : workOrderInfoList " + workOrderInfoList + "\n");
...
//	}
    ...
    public int editActualAmount(@RequestBody WorkOrderInfoTO workOrderInfoTO) {
        ...
        System.out.println("\n" + "디버깅 포인트 : workOrderInfoTO = " + workOrderInfoTO);
        System.out.println(workOrderInfoTO.getWorkOrderNo());
        System.out.println(workOrderInfoTO.getActualCompletionAmount() + "\n");
        int count = 0;
        try {
