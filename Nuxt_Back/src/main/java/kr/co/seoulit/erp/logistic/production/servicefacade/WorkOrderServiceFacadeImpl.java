...
public class WorkOrderServiceFacadeImpl implements WorkOrderServiceFacade {
    ...
    public HashMap<String, Object> getWorkOrderableMrpList() {
        ...
        System.out.println("\n" + "디버깅 포인트 : workorderServiceFacadeImpl" + map);
        System.out.println("디버깅 포인트 : workorderServiceFacadeImpl" + map.get("result") + "\n");
    ...
    @Override
    public HashMap<String, Object> workOrder(String mrpNo, String mrpGatheringNo, String workPlaceCode, String productionProcessCode) {
    ...
    public List<WorkOrderInfo> getWorkOrderInfoListStatus() {
        ...
        List<WorkOrderInfo> workOrderInfoList = workOrderRepository.findByOperationCompletedIsNull();
