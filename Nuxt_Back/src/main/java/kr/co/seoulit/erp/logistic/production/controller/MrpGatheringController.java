...
public class MrpGatheringController {
    ...
    public ResponseEntity<HashMap<String,Object>> getMrpGatheringList(@RequestParam String mpsNoList) {
        System.out.println("\n"+"디버깅 포인트 : 반재품, 완재품인 경우 필요수량은 생산하여야 합니다.");
