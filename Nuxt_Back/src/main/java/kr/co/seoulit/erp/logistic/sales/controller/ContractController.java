...
public class ContractController {
	...
	public ModelMap searchContract(@RequestParam("customerCode") String customerCode, @RequestParam("searchCondition") String searchCondition,
	...
	public HashMap<String, Object> addNewContract(@RequestBody Map<String, Object> paramList) {
		...
		HashMap<String, Object> resultMap = new HashMap<>();
		System.out.println("디버깅 포인트 : ContractController");
