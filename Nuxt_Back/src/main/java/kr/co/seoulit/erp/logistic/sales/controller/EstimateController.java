...
//		String dateSearchCondition = request.getParameter("dateSearchCondition");
	...
	@RequestMapping("sales/predictNextDay")
	public HashMap<String, String> predictNextDay(){
		HashMap<String, String> predictNextDay = salesSF.getPredictNextDay();
		return predictNextDay;
	}
