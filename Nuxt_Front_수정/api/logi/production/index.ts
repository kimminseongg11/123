...
//실제 작업지시
function getActualWorkOrderButton( mrpNo: string, mrpGatheringNo: string, workPlaceCode: string, productionProcessCode: string ) {
...
//작업완료된 수량 입력
function putActualAmount(workOrderInfoTO: any, actualCompletionAmount: any) {
  return logiApi.put(`${EDIT_ACTUAL_AMOUNT_URL}`, workOrderInfoTO, actualCompletionAmount);
}
